...
soln = Solution()
assert soln.canJump([0]) == True, "failed"
assert soln.canJump([1]) == False, "failed"
assert soln.canJump([2, 3, 1, 1, 4]) == True, "failed"
assert soln.canJump([3, 2, 1, 0, 4]) == False, "failed"
